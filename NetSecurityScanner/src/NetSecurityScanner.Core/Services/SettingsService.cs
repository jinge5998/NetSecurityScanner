    ...
    public class SettingsService
    {
        ...
        public AppSettings GetDefaultSettings()
        {
            return new AppSettings
            {
                ...
                {
                    GitHubOwner = "", // 必须修改为您的 GitHub 用户名
        ...
        public UpdateSettings GetUpdateSettings()
        {
            lock (_lockObject)
            {
                return _currentSettings.UpdateSettings;
            }
        }
        ...
        {
            return await Task.FromResult(GetUpdateSettings());
        }

        /// <summary>
        /// 保存更新设置
        /// </summary>
        public bool SaveUpdateSettings(UpdateSettings updateSettings)
        {
            try
            {
                lock (_lockObject)
                {
                    _currentSettings.UpdateSettings = updateSettings;
                    return SaveSettings(_currentSettings);
                }
            }
            catch (Exception ex)
            {
                Console.WriteLine($"保存更新设置失败: {ex.Message}");
                return false;
            }
        }
        ...
        /// 异步保存更新设置
        /// </summary>
        public async Task<bool> SaveUpdateSettingsAsync(UpdateSettings updateSettings)
        {
            return await Task.FromResult(SaveUpdateSettings(updateSettings));
        }
    }
