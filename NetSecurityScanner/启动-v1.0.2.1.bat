@echo off
chcp 65001 >nul
title NetSecurityScanner v1.0.2.1 启动器
color 0B

echo ============================================
echo   NetSecurityScanner v1.0.2.1 - 启动中...
echo ============================================
echo.
echo [特性] Rust 引擎已集成到专家模式
echo.

cd /d "%~dp0publish-v1.0.2.1"
...
if exist "NetSecurityScanner.Desktop.exe" (
    ...
    echo.
    echo 请检查 publish-v1.0.2.1 目录是否存在
)
